...
const BAR_SEGMENT_CANONICAL_BY_COMPANY = Object.freeze({
  ...
  micron: Object.freeze({
    cnbu: "microncomputenetworking",
    cdbu: "microncoredatacenter",
    mbu: "micronmobile",
    mcbu: "micronmobileclient",
    sbu: "micronstorage",
    cmbu: "microncloudmemory",
    ebu: "micronembedded",
...
const BAR_SEGMENT_LABEL_OVERRIDES = Object.freeze({
  ...
  microncomputenetworking: Object.freeze({ name: "Compute & Networking", nameZh: "计算与网络" }),
  microncoredatacenter: Object.freeze({ name: "Core Data Center", nameZh: "核心数据中心" }),
  microncloudmemory: Object.freeze({ name: "Cloud Memory", nameZh: "云内存" }),
  micronstorage: Object.freeze({ name: "Storage", nameZh: "存储" }),
  micronmobile: Object.freeze({ name: "Mobile", nameZh: "移动" }),
  ...
  micronembedded: Object.freeze({ name: "Embedded", nameZh: "嵌入式" }),
...
const BAR_SEGMENT_COLOR_SLOT_OVERRIDES = Object.freeze({
  ...
  microncomputenetworking: 0,
  microncoredatacenter: 0,
